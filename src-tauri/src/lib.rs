...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::github_workspace::github_search,
            commands::github_workspace::github_detail,
            commands::github_workspace::github_conversation,
            commands::github_workspace::github_files,
            commands::github_workspace::github_action,
